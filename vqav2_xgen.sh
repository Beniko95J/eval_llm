...
CKPT="xGEN-MM-base-random-few-shots-8"
SPLIT="llava_vqav2_mscoco_test2015"

# for IDX in $(seq 0 $((CHUNKS-1))); do
#     CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m eval.model_vqa_loader \
...
CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m eval.random_xgen_vqa_loader \
    --question-file ./playground/data/eval/vqav2/$SPLIT.jsonl \
    --image-folder ./playground/data/eval/vqav2/test2015 \
    --answers-file ./playground/data/eval/vqav2/answers/$SPLIT/$CKPT/${CHUNKS}_${IDX}.jsonl \
    --num-chunks $CHUNKS \
